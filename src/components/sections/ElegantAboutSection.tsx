...
export function ElegantAboutSection() {
  return (
    <section id="about" className="elegant-section bg-soft-white">
      <div className="elegant-container">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Badge className="mb-6 bg-light-gold text-navy border-warm-gold px-6 py-2">
            About Dr. Rachha
          </Badge>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start mb-20">
          ...
          >
            <div className="luxury-card p-8">
              <div className="flex items-start space-x-6 mb-8">
                <div className="w-24 h-24 rounded-2xl bg-warm-gold flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-warm-gold font-semibold text-lg mb-2">
              ...
              <div className="space-y-6">
                ...
                <div className="elegant-card p-6 bg-light-gold border-l-4 border-warm-gold">
                  <blockquote className="font-accent text-lg italic text-navy leading-relaxed">
            ...
            <div className="space-y-6">
              {expertise.map((item, index) => (
                <motion.div
                  key={item.title}
                  className="elegant-card p-6 group hover:border-warm-gold"
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="bg-light-gold rounded-xl p-3 group-hover:bg-warm-gold transition-colors">
                    ...
                    <div className="flex-1">
                      ...
                      <Badge className="bg-sage-green text-white text-xs">
                        {item.stats}
                      </Badge>
                    </div>
                  </div>
          ...
          >
            <div className="relative">
              {/* Timeline Line */}
              <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-warm-gold via-sage-green to-navy"></div>
                ...
                {timeline.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="absolute left-1/2 transform -translate-x-1/2 z-10">
                      <motion.div
                        className="w-16 h-16 rounded-full bg-warm-gold flex items-center justify-center shadow-lg"
                    ...
                    <div className={`w-5/12 ${item.side === 'left' ? 'mr-auto pr-8' : 'ml-auto pl-8'}`}>
                      ...
                      >
                        <div className="text-warm-gold font-bold text-xl mb-2">
                          {item.year}
                        </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {memberships.map((membership, index) => (
              <motion.div
                key={membership}
                className="elegant-card p-6 text-center group hover:border-warm-gold"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1, duration: 0.6 }}
                viewport={{ once: true }}
              ...
              >
                <Award className="h-12 w-12 text-warm-gold mx-auto mb-4 group-hover:scale-110 transition-transform" />
                <h4 className="font-semibold text-navy text-center leading-snug">
                  {membership}
                </h4>
              </motion.div>
            ))}
        ...
        >
          <div className="premium-card p-12 text-center">
            ...
            >
              <Heart className="h-16 w-16 text-warm-gold mx-auto" />
            </motion.div>
            ...
            <p className="body-large text-warm-gray max-w-3xl mx-auto mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-warm-gold mb-2">Manavya</div>
                <div className="text-warm-gray">Supporting underprivileged children</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-sage-green mb-2">Being Social</div>
                <div className="text-warm-gray">Community welfare initiatives</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-navy mb-2">Carbonari</div>
                <div className="text-warm-gray">Specially-abled children support</div>
              </div>
            </div>
          </div>
        </motion.div>
...
export default ElegantAboutSection; 