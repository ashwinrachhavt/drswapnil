    ...
    <>
      ...
      >
          ...
          <div className="flex items-center justify-between h-20 lg:h-24">
            ...
            >
              <div className="relative">
                <motion.div
                  className="w-12 h-12 lg:w-14 lg:h-14 rounded-2xl bg-gradient-to-br from-navy to-sage-green flex items-center justify-center shadow-lg"
                  whileHover={{ rotate: 5 }}
                ...
                {/* Elegant Glow Effect */}
                <motion.div
                  className="absolute inset-0 rounded-2xl bg-warm-gold opacity-20 blur-lg"
              ...
              <div>
                ...
                <p className="text-sm lg:text-base text-warm-gold font-medium">
                  Pediatric Dentist
                </p>
              </div>
            </motion.div>
              ...
              {navigationItems.map((item, index) => (
                ...
                >
                  <Button
                    ...
                    className={`relative px-6 py-3 rounded-xl font-medium transition-all duration-300 group ${
                      activeSection === item.href.slice(1)
                        ? "text-warm-gold bg-light-gold"
                        : "text-charcoal hover:text-warm-gold hover:bg-light-gold"
                    }`}
                  ...
                  >
                    ...
                    {activeSection === item.href.slice(1) && (
                      <motion.div
                        className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-6 h-0.5 bg-warm-gold rounded-full"
                    ...
                    {/* Hover Effect */}
                    <motion.div
                      className="absolute inset-0 rounded-xl bg-warm-gold opacity-0 group-hover:opacity-10 transition-opacity"
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              className="lg:hidden absolute top-full left-0 right-0 bg-soft-white shadow-luxury border-t border-warm-gold/20"
            ...
            >
              <div className="elegant-container py-8">
                ...
                {/* Mobile CTA Buttons */}
                <motion.div
                  className="flex flex-col space-y-4 mt-8 pt-8 border-t border-warm-gold/20"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
